...
const API_URL = `${process.env.API_DOMAIN_NAME}/create-meal`;
const TOKEN = process.env.BEAREAR_TOKEN;
...
async function createMeal(
  ...
  const res = await fetch(API_URL, {
    ...
    body: JSON.stringify({ contentType: fileType, fileSize }),
  });
