...
| PreTokenGeneration | `preTokenGenerationTrigger` | Injeta o claim `internalId` no access token para uso como `accountId`    |
...
- JWT Authorizer configurado com o Cognito UserPool
